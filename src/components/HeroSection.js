    ...
    <section id="hero" className={styles.hero}>
      ...
      <div className={`container ${styles.content}`}>
        ...
        <div className={styles.monikerWrapper}>
          <span className={styles.moniker}>A.M.</span>
        </div>

        {/* Name & Title */}
        <h1 className={styles.name}>
          Abdullah<span className={styles.nameSpacer}> </span>Mehmood
        </h1>
        <p className={styles.headline}>
          Data Science <span className={styles.ampersand}>&</span> Machine
          Learning
        </p>

        {/* Brief tagline */}
        <p className={styles.tagline}>
          Building intelligent systems with rigorous mathematical modeling,
          deep learning architectures, and production-grade ML pipelines.
        </p>

        {/* CTA Buttons */}
        <div className={styles.ctas}>
          <a
            href="https://github.com/Abdullah-Mehmood-242"
            target="_blank"
          ...
          <a
            href="https://linkedin.com/in/abdullahmehmood242"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://www.fiverr.com/abdullah_m_242"
            target="_blank"
            rel="noopener noreferrer"
            className="btn btn-outline"
            id="hero-fiverr-btn"
          ...
          <a
            href="/Abdullah_Mehmood_Resume.pdf"
            download
